...
public class Main {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        String bandName = "Guns n Roses";
        String upperCaseName = bandName.toUpperCase();
        String lowerCaseName = bandName.toLowerCase();
        System.out.println (upperCaseName + " & " + lowerCaseName);
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "testResult" + 1.5 ;// <--- Edit this line
