...
public class Main {
    ...
    private static void exercise2() {
        ...
        if (remainingMoney >= lunchCost){
            ...
            System.out.println( "You have only "+ (remainingMoney)+" in your wallet :(. You go hungry today");
        }
    ...
    private static void exercise3() {
        ...
        System.out.println((ourDouble) + " is greater than 2.5");
            ...
            ourDouble+= 1.0;
            if(ourDouble>2.5){
                System.out.println((ourDouble) + " is Now greater than 2.5");
            }else {
                System.out.println((ourDouble) + " Still less than 2.5");
            }
        }
